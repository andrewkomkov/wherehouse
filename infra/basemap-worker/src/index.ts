// Vendored from protomaps/PMTiles serverless/cloudflare (BSD-3-Clause), pmtiles@4.4.1.
// Only change from upstream: the shared path helpers are vendored next to this file
// instead of being imported from ../../shared/index, which does not exist outside
// the upstream monorepo layout.
import {
  Compression,
  EtagMismatch,
  PMTiles,
